...
<body id="mimin" class="dashboard">
    ...
    <script src="${pageContext.request.contextPath}/resources/asset/js/plugins/flot/jquery.flot.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/asset/js/plugins/flot/jquery.flot.pie.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/asset/js/plugins/flot/jquery.flot.time.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/asset/js/plugins/flot/jquery.flot.navigate.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/asset/js/plugins/flot/jquery.flot.stack.min.js"></script>
